...
public class ReaderTest extends TestCase {
    ...
    public void testClass() throws FileNotFoundException {
        try {
            ...
            Reader test = new Reader(6, "P2SampleInput.txt");
            assertEquals(outContent.toString(),
                "|Darth Vader| not deleted because it does"
                    ...
                    + "|John Doe| has been deleted from the Reviewer "
                    + "database.\r\n" + "|Spirited Away| has been "
                    + "deleted from the Movie database.\r\n"
                    ...
                    + "|Death Note| has been deleted from the Movie "
                    + "database.\r\n"
                    + "Ratings for reviewer |Darth Vader|:\r\n"
                    + "Rating added: |Darth Vader|, |Death Note|, 1\r\n"
                    + "Rating added: |David Lynch|, |Twin Peaks Returns|, "
                    + "10\r\n" + "Darth Vader: 4\r\n" + "David Lynch: 5\r\n"
                    ...
                    + "Rating added: |Darth Vader|, |Twin Peaks Returns|"
                    + ", 1\r\n" + "Darth Vader: 4\r\n" + "David Lynch: 5\r\n"
                    + "Dr. Shaffer: 6\r\n" + "Death Note: 4:1 5:2\r\n"
